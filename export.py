...
def add_input(instance, nJobs, nMachines, resources, alpha, ub, elapsed_time, filename):
    with open(filename, 'a') as outfile:
        outfile.write(f"{instance};{nJobs};{nMachines};{resources};{alpha};{ub};{elapsed_time}\n")
    outfile.close()