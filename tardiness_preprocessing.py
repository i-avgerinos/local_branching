...
def input_data(data, solutions, big_M):
    ...
    solution = {int(m): [x for x in solutions['Seq'][str(m)]] for m in solutions['Seq'].keys()} # The warm-start solution
    ...
    return nJobs, nMachines, alpha, tau, rho, processing_times, setup_times, deadlines, setup_minus, solution